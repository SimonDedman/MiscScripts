...
ggplot() +
  ggspatial::annotation_spatial(natlantic, fill = "grey", lwd = 0) +
  ggspatial::layer_spatial(sf_lines, size = 0.75, aes(color = ID)) +
  ggplot2::theme(legend.position = "none") +
  #scale_color_viridis_d() +
  ggplot2::scale_x_continuous(breaks = seq(-180, 180, by = 5)) +
  ggplot2::ggtitle("Atlantic bluefin tuna tracks",
